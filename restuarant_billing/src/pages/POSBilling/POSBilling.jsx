...
export default function POSBilling() {
  ...
  const restaurantId = JSON.parse(localStorageUser)?.store?.restaurant;

  const storeId = JSON.parse(localStorageUser)?.store?._id;
...
console.log("storeId", storeId);
  const handleOrderCreated = (
    ...
    // Here you can open payment modal
    // or refresh recent orders.
  };
