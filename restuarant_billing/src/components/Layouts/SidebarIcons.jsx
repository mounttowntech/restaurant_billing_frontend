...
export const DashboardIcon = (props) => (
  ...
  >
    ...
    <rect x="14" y="3" width="7" height="4" rx="1.5" fill="currentColor" />
    <rect x="14" y="10" width="7" height="11" rx="1.5" fill="currentColor" />
    <rect x="3" y="13" width="7" height="8" rx="1.5" fill="currentColor" />
  </svg>
);

export const POSIcon = (props) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const PurchaseIcon = (props) => (
  ...
  >
    ...
    <path d="M2.5 4h2.4l2.1 11.2a2 2 0 0 0 2 1.6h8.2a2 2 0 0 0 2-1.6L21 8H6" />
  </svg>
);
...
export const ReturnsIcon = (props) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
  ...
  >
    ...
    <path d="M13 10.5 10 13l3 2.5" />
    <path d="M10 13h4.5a2 2 0 0 1 0 4H13" />
  </svg>
);
...
export const CustomersIcon = (props) => (
  ...
  >
    ...
    <path d="M14.8 12.2A5 5 0 0 1 21 16.8" />
  </svg>
);
...
export const RestaurantIcon = (props) => (
  ...
  >
    ...
    <path d="M7 13v8" />
    <path d="M15 3v18" />
    <path d="M15 3c3 1 4 3.5 4 6v2h-4" />
  </svg>
);
...
export const BrandIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M6 8a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2l1 11a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2L6 8Z" />
